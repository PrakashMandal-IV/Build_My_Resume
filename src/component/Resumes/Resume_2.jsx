                            ...
                            <div className="w-1/2 flex flex-col gap-2">
                                <div className="pl-10 h-2/5  bg-black flex flex-col  ">
                                    <div className="mt-16">
                                        ...
                                        <p className="mt-5 font-light  text-2xl text-white">{Information?.PersonalData?.Profession}</p>
                                    </div>
                                    ...
                                    <div className="pl-4  w-5/6">
                                        <div className="mt-5 flex flex-col gap-1">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                {Information?.Certificates.slice(0, 5).map((item, idx) => (
                                                    <div className="flex flex-col border rounded-md py-1 px-2" key={idx}>
