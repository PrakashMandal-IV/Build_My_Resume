...
function Resume_1(props) {
  ...
  const PrintResume = () => {
    let Html = `<html>
      ...
      <body>
      <div class="header" style="height: 160px;background-color:rgb(229 231 235)">
      <div style="display: flex; flex-direction: column; height: 100%; width: 100%;">
        <div style="margin-top: auto; margin-bottom: auto; display: flex;">
          <div style="flex-grow: 1; margin-left: 52px;">
            <p class="border" style="font-size: 10px;">Resume</p>
            <p style="font-size: 20px; font-weight: 500; letter-spacing: 2px;">
              ${Information.PersonalData.FirstName}  ${Information.PersonalData.LastName}
            </p>
            <p style="font-size: 10px;">${Information.PersonalData.Profession}</p>
          </div>
          <div style="flex-grow: 1; display: flex; flex-direction: column; gap: 2px;">
            <div style="margin-left: auto; margin-right: 25px; display: flex; flex-direction: column; gap: 4px;">
              <div style="display: flex; letter-spacing: 2px; gap: 3px;">
                <p style="font-size: 8px; font-weight: bold;">T : </p>
                <p style="font-size: 8px;">${Information.PersonalData.Contact.Phone}</p>
              </div>
              <div style="display: flex; letter-spacing: 2px; gap: 3px;">
                <p style="font-size: 8px; font-weight: bold;">M : </p>
                <a href="mailto:${Information.PersonalData.Contact.Email}" target="_blank" style="font-size: 8px;">${Information.PersonalData.Contact.Email}</a>
              </div>
              <div style="display: flex; letter-spacing: 2px; gap: 3px;">
                <p style="font-size: 8px; font-weight: bold;">W : </p>
                <a href="${Information.PersonalData.Contact.Website}" target="_blank" style="font-size: 8px;">${Information.PersonalData.Contact.Website}
            </div>
          </div>
        </div>
      </div>
    </div>
    <div style="margin-top: 40px; display: flex; flex-direction: column; gap: 20px; margin-left: 40px; margin-right: 50px; flex-grow: 1;">
    <p style="margin-left: 12px; font-weight: 500; font-size: 12px; letter-spacing: 2px; border-bottom: 1px solid orange;">Welcome to my Resume</p>
        <div style="display: flex; gap: 10px; height: 100%; margin-bottom: 5px;">
            <div style="width: 40%; display: flex; flex-direction: column; gap: 20px;">
            <div>
              <p class="titles">Education</p>
              <div class="left-items" style="margin-left: 12px;">
                `
           Information.Education.forEach(item => {
                 Html += `<div class="item">
                 <div class="item-title">
                   <div class="item-dot"></div>
                   <p style="font-size: 10px;">${item.Title}</p>
                 </div>
                 <p style="font-size: 8px; margin-left: 6px; color: gray;">${item.Duration}</p>
               </div>`
           });     
            ...
            Html+= `
              ...
              <div class="left-items" style="margin-left: 12px;">
              `
              Information.Skills.forEach(item => {
                   Html+=`<div class="item" style="padding-bottom: 4px;">
                   <div class="item-title">
                     <div class="item-dot"></div>
                     <p class="" style="font-size: 10px;">${item.Title}</p>
                   </div>
                   <div class="" style="display: flex; margin-left: 6px; gap: 5px;">
                     <div class="" style="background-color: orange; width: 20px; height: 4px;"></div>
                     <div class="" style="background-color: orange; width: 20px; height: 4px;"></div>
                     <div class="" style="background-color: rgb(212, 212, 212); width: 20px; height: 4px;"></div>
                     <div class="" style="background-color: rgb(212, 212, 212); width: 20px; height: 4px;"></div>
                   </div>
                 </div>`
              });
            ...
            <div>
                ...
                <div class="left-items" style="margin-left: 12px;">
                `
                Information.Hobbies.forEach(item=>{

                    Html+=`
                    <div class="item">
                           <div class="item-title">
                             <div class="item-dot"></div>
                             <p class="" style="font-size: 10px">${item}</p>
                           </div>
                         </div>`
             ...
             Html+=`
                ...
                <div class="">
                    <p class="titles">Socials</p>
                    <div class="left-items" style="margin-left: 12px; display: flex; gap: 10px;">

                    `
                    Information.Socials.forEach(item=>{
                   Html+=`   <div className="">`
                    {item.Type === "instagram" && (
             ...
             Html+=`
                ...
                <div style="width: 40%; display: flex; flex-direction: column; gap: 20px; flex-grow: 1;">
                <div className="">
                ...
                <div style="display: flex; gap: 10px;">
                   <div style="flex-grow: 1;">
                    <p class="mainPageTitle">Experience</p>
                    <div class="left-items" style="margin-left: 12px;">
                      `
                      Information.Experience.forEach(item=>{
                        Html+=`<div class="item" >
                        <div class="item-title" style="padding-bottom: 0;">
                          <div class="item-dot"></div>
                          <p style="font-size: 10px;">${item.Title}</p>
                        </div>
                        <p style="font-size: 8px; margin-left: 6px; color: gray;">${item.JobTitle}</p>
                        <p style="font-size: 8px; margin-left: 6px; color: gray;">${item.Duration}</p>
                      </div>
                      `
                      })
              ...
              <div style="flex-grow: 1;">
              <p class="mainPageTitle">Certificates</p>
              <div class="left-items" style="margin-left: 12px;">
                    `
                    Information.Certificates.forEach(item=>{
                      Html+=`<div class="item">
                      <div class="item-title">
                        <div class="item-dot"></div>
                        <p  style="font-size: 10px;">${item.Title}</p>
            ...
            <div>
                <div style="display: flex;">
                  <p class="mainPageTitle">Projects</p>
                  <a href="" style="margin-left: auto; font-size: 12px; margin-top: auto;">See more &gt;&gt;</a>
                </div>
                <div style="margin-top: 5px; display: flex; flex-direction: column; gap: 4px;">
                  `
                  Information.Projects.forEach(item=>{
      ...
      Html+='</body></html>'
      // const winPrint = window.open('', '', 'toolbar=0');
