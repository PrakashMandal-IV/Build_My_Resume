...
function Resume_1() {
  ...
  return (<>
    ...
    <div className="body border mt-5">
      ...
      {/* Body */}
            <div className="" style={{marginTop:"60px",display:"flex",flexDirection:"column",marginLeft:"40px" ,marginRight:"50px"}}>
                  <p className="" style={{marginLeft:"10px",fontWeight:"500",letterSpacing:"2px"}}>Welcome to my Resume</p>
                  <div className="border border-red-500" style={{display:"flex"}}>
