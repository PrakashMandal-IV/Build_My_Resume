                ...
                <div className="flex h-full">
                    ...
                    <div className="w-1/2  flex">
                        <div className="w-3/4 mx-auto flex flex-col gap-10">
                            {/* Image */}
                            <div className="h-96   rounded-b-full flex p-5 bg-pink-300">
                                <div className="w-[17rem] h-[16rem]  mt-auto  rounded-full overflow-hidden">
                                ...
                                <div className="flex flex-col gap-2 mt-3 pl-4">
                                    {Information?.Education?.slice(0, 8).map((item, idx) => (
                                        <div className="" key={idx}>
                                            ...
                                            <p className="text-xs font-light text-gray-700">{item.From}</p>
                                            <p className="text-xs font-light text-gray-700">{item.Duration}</p>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="flex flex-col gap-2 mt-3 px-4">
                                    {Information?.Skills?.slice(0, 8).map((item, idx) => (
                                        <div className="flex flex-col w-full" key={idx}>
                                            ...
                                            <div className="flex">
                                                <div className=" h-2 flex-grow w-4/6 my-auto rounded-full ">
                                                    <div className=" h-full bg-pink-300 rounded-full" style={{ width: `${item.Level}%` }}></div>
                                                </div>
                    ...
                    <div className="w-1/2  flex">
                        <div className=" mx-auto flex flex-col gap-10">
                            <div className="mt-10">
                                <p className="text-4xl font-semibold">{Information?.PersonalData?.FirstName.toLocaleUpperCase()}</p>
                                <p className="text-4xl font-semibold">{Information?.PersonalData?.LastName.toLocaleUpperCase()}</p>
                           ...
                           {Information?.Experience?.lenght!==0&&( <div className="flex flex-col">
                                ...
                                <div className="flex flex-col gap-2 mt-3 px-4">
                                    {Information?.Experience?.slice(0, 3).map((item, idx) => (
                                        <div className="flex flex-col w-full" key={idx}>
                                            <p className="text-sm font-semibold ">{item.Job} | {item.Company}</p>
                           ...
                           {Information?.Projects?.lenght!==0&&( <div className="flex flex-col">
                                ...
                                <div className="flex flex-col gap-2 mt-3 px-4">
                                    {Information?.Projects?.slice(0, 3).map((item, idx) => (
                                        <div className="flex flex-col w-full" key={idx}>
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="flex flex-col gap-2 mt-3 px-4">
                                    {Information?.PersonalData?.Contact?.Email !== "" && (<div className="flex gap-4">
                                        <div className="w-6">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="rgb(249 168 212)" className="w-6 h-6">
                                    ...
                                    {Information?.PersonalData?.Contact?.Phone !== "" && (<div className="flex gap-4">
                                        <div className="w-6">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="rgb(249 168 212)" className="w-5 h-5">
