            ...
            <div id="printable-area" ref={props.printref} className="body bg-white " size="A4">
                ...
                <div className="flex h-full">
                    ...
                    <div className="w-1/2 bg-gradient-to-br from-slate-800 to-slate-600  flex flex-col gap-10 pl-10">
                        ...
                        {Information?.Skills?.lenght!==0&&(<div className="flex flex-col gap-4 pr-10">
                       ...
                       {Information?.Hobbies?.lenght!==0&&( <div className="flex flex-col gap-4 pr-10">
                       ...
                       {Information?.Certificates?.lenght!==0&&( <div className="flex flex-col gap-4 pr-10">
                            <p className="text-white font-semibold text-lg"> <span className="border-b">Certificates & Achievments</span></p>
                            <div className="flex  gap-2 flex-wrap">
                    ...
                    <div className="w-1/2">
                        <div className="mt-16 ml-10">
                            <p className="text-3xl font-medium">{Information?.PersonalData?.FirstName} {Information?.PersonalData?.LastName}</p>
                            <p className="text-sm text-gray-600">{Information?.PersonalData?.Profession}</p>
                        </div>
                        ...
                        {Information?.Socials?.lenght!==0&&(<div className="ml-10 mt-3 flex gap-1">
                        ...
                        <div className="flex mt-4">
                            <div className="flex flex-col">
                                <div className="h-8 bg-yellow-500 flex -translate-x-4 mb-5 ">
                                    <p className="text-white text-center my-auto ml-14">Education</p>
                                </div>
                                <div className="flex flex-col gap-2">
                                    {Information?.Education?.slice(0, 5).map((item, idx) => (
                                        <div className="ml-10" key={idx}>
                                            ...
                                            <p className="font-normal text-xs text-gray-500">{item.From}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        {Information?.Experience?.lenght!==0&&(<div className="flex mt-8 b">
                            <div className="flex flex-col">
                                <div className="h-8 bg-yellow-500 flex -translate-x-4 mb-5  w-52">
                                    <p className="text-white text-center my-auto ml-14">Job Experience</p>
                                </div>
                                <div className="flex flex-col gap-2">
                                    {Information?.Experience?.slice(0, 5).map((item, idx) => (
                                        <div className="ml-10" key={idx}>
                                            ...
                                            <p className="font-normal text-xs text-gray-500">{item.Company}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        </div>)}
                       {Information?.Projects?.lenght!==0&&( <div className="flex mt-8 b">
                            <div className="flex flex-col">
                                <div className="h-8 bg-yellow-500 flex -translate-x-4 mb-5  w-52">
                                    <p className="text-white text-center my-auto ml-14">Projects</p>
                                </div>
                                <div className="flex flex-wrap gap-2 ml-10">
                                    {Information?.Projects?.slice(0, 5).map((item, idx) => {
                                        if (item.Link === "") {
                                            return (<div className="" key={idx}>
                                                <p className="text-sm px-2 font-medium  py-1 border">{item.Title}</p>
                                            </div>)
                                        } else {
                                            return (<a href={item.Link} target="_blank" className=" cursor-pointer" key={idx}>
                                                <p className="text-sm px-2 font-medium  py-1 border">{item.Title}</p>
                                            </a>)
                                        }
                                    })}
