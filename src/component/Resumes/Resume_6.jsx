    ...
    return (<>
        {Information && (
            <div id="printable-area" ref={props.printref} className="body  flex " size="A4">
                {/* body */}
                <div className="w-2/5 h-full bg-gradient-to-b from-[#333a4c]  to-[#495168] border flex flex-col gap-5 pl-14">
                    <div className=" h-60 mt-10 flex align-middle">
                    ...
                    <div className="flex flex-col gap-4">
                        <p className="border-b-2  text-white text-2xl">Contact</p>
                        <div className="flex flex-col gap-1">
                            ...
                            {Information?.PersonalData?.Contact.Website !== "" && (
                                <div className="flex gap-4">
                                    ...
                                    <a href={Information?.PersonalData?.Contact.Website} target="_blank" className="text-white text-sm font-light" >My Portfolio</a>
                                </div>
                            )}
                            {Information?.PersonalData?.Contact.Location !== "" && (
                                <div className="flex gap-4">
                                    ...
                                    <p target="_blank" className="text-white text-sm font-light" >{Information?.PersonalData?.Contact.Location}</p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="flex flex-col gap-1 text-white">
                            {Information?.Education?.slice(0, 8).map((item, idx) => (
                                <div className="" key={idx}>
                                    ...
                                    <p className="text-xs font-light text-gray-200">{item.From}</p>
                                    <p className="text-xs font-light text-gray-200">{item.Duration}</p>
                                </div>
                            ))}
                        </div>
