        ...
        {Information && (
            <div id="printable-area" ref={props.printref} className="body bg-gray-50  flex  " size="A4">
                ...
                <div className="flex h-full">
                    <div className="w-2/5 h-full bg-gradient-to-b from-[#333a4c]  to-[#495168] flex flex-col gap-6 pl-14">
                        <div className=" h-60 mt-10 flex align-middle flex-col">
                    ...
                    <div className="w-3/5 flex-grow px-10 text-[#333a4c] ">
                        <div className="mt-10 ">
                            <p className="text-4xl font-semibold  ">{Information?.PersonalData?.FirstName.toUpperCase()} <span className="font-normal ">{Information?.PersonalData?.LastName.toUpperCase()} </span> </p>
                            ...
                            <div className="mt-4">
                                {Information?.Experience?.slice(0, 4).map((item, idx) => (
                                    <div className="flex " key={idx}>
                                        ...
                                        <div className=" border-l-2 border-black pl-5 flex flex-col">
                                            <p className=" font-semibold ">{item.Company}<span className="font-normal"> | {item.Job}</span> </p>
                                            <p className="text-xs font-medium mb-1 ">{item.Duration}</p>
                                            <p className="text-xs pb-1">{item.Details}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
